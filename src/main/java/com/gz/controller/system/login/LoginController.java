package com.gz.controller.system.login;
...
import com.gz.entity.system.Menu;
...
import com.gz.util.RightsHelper;
...
public class LoginController extends BaseController {
	...
	public Object login()throws Exception{
		...
		pd = this.getPageData();
		String errInfo = "";
		String KEYDATA[] = pd.getString("KEYDATA").replaceAll("qq357049881gz", "").replaceAll("QQ357049881gz", "").split(",gz,");
