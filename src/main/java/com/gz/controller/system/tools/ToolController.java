package com.gz.controller.system.tools;
...
import com.gz.util.MapDistance;
import com.gz.util.PageData;
import com.gz.util.PathUtil;
import com.gz.util.TwoDimensionCode;
...
public class ToolController extends BaseController {
	...
	public ModelAndView getCheckin() throws Exception{
		ModelAndView mv = this.getModelAndView();


		mv.setViewName("system/tools/checkin");

		return mv;
	}

	@RequestMapping(value="/checkin2")
	public ModelAndView getCheckin2() throws Exception{
		ModelAndView mv = this.getModelAndView();


		mv.setViewName("system/tools/checkin2");
